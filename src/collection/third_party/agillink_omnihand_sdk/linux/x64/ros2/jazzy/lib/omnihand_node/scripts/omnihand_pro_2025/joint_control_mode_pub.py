#!/usr/bin/env python3
"""
@Description: Publish control mode values to OmniHandPro2025 (O12) and
...
ControlMode values: 0=POSITION, 1=SERVO, 2=VELOCITY, 3=TORQUE, 4=VOLTAGE, 7=PROFILE_POSITION

Usage:  python3 joint_control_mode_pub.py <mode> [left|right] [product]
        default: mode=0, side=left, product=o12
"""
...
class ControlModePubSub(Node):
    def __init__(self, hand_side: str, product: str, mode: int):
        ...
        self.publisher.publish(make_int8_multi_array([mode] * NUM_JOINTS))
