...
def test_business_nodes_do_not_embed_an_mcap_writer():
    ...
    node_paths = (
        collection_root / "rokoko_hand_receiver_node" / "rokoko_hand_receiver" / "node.py",
        collection_root / "hand_retargeting_node" / "hand_retargeting" / "node.py",
        collection_root / "omnihand_o10_control_node" / "omnihand_o10_control" / "node.py",
    )
