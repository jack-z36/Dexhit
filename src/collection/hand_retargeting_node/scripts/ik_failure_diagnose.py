...
# --- bootstrap: make the explicitly mapped ament packages importable from source ---
_COLLECTION_ROOT = Path(__file__).resolve().parents[2]
for _candidate in (
    _COLLECTION_ROOT / "hand_retargeting_node",
    _COLLECTION_ROOT / "teleoperation_support" / "o10_contracts",
    _COLLECTION_ROOT / "teleoperation_support" / "o10_model_assets",
):
